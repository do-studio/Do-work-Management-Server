...
const reminderRoute = () => {
    ...
    router.post('/', authMiddleware, reminderController.createReminder); // Create a reminder for a specific month
    ...
    router.get('/', authMiddleware, reminderController.getRemindersByMonth); // Get reminders for a specific month
